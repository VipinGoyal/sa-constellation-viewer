                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-medium text-black">Search Location</h3>
                      </div>

                      <div className="relative">
                        <div className="bg-white border border-gray-300 hover:border-gray-400 focus-within:border-black rounded-md overflow-hidden transition-colors">
                          <Input
                            placeholder="Start typing to search for a city..."
                            value={searchQuery}
                            onChange={(e) => setSearchQuery(e.target.value)}
                            className="pr-10 border-0 text-black w-full focus:ring-0 focus:ring-offset-0"
                          />
                        </div>
                        {isSearching && (
                      ...
                      {searchResults.length > 0 && (
                        <div className="grid gap-2 mt-2 max-h-[120px] overflow-y-auto">
                          {searchResults.map((result, index) => (
                            <div
                              key={index}
                              className="p-2 border border-gray-300 rounded-md hover:bg-gray-100 hover:border-black cursor-pointer transition-colors"
                              onClick={() => handleSelectLocation(result)}
                            >
                              <div className="flex items-center gap-2">
                                <MapPin className="h-4 w-4 text-black shrink-0" />
                                <div>
                                  <div className="font-medium text-black text-sm">{result.name}</div>
                      ...
                      {debouncedSearchQuery && !isSearching && searchResults.length === 0 && (
                        <div className="text-center p-2 text-black bg-gray-100 rounded-md text-sm">
                      ...
                      {showPopularCities && (
                        <div className="mt-2">
                          <h4 className="text-sm font-medium text-black mb-2">Popular Cities</h4>
                          <div className="grid grid-cols-2 gap-2 max-h-[120px] overflow-y-auto pb-1">
                            {popularCities.slice(0, 18).map((city, index) => (
                              ...
                              >
                                <div className="font-medium text-black truncate text-sm">{city.name}</div>
                              </div>
                            ))}
                          </div>
                        </div>
                    ...
                    <div className="space-y-4 pt-4 border-t">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-medium text-black">Manual Coordinates</h3>
                      </div>
                        ...
                        <div className="grid gap-2">
                          ...
                          <div className="bg-white border border-gray-300 hover:border-gray-400 focus-within:border-black rounded-md overflow-hidden transition-colors">
                            <Input
                              ...
                              className="border-0 text-black w-full focus:ring-0 focus:ring-offset-0"
                            />
                          </div>
                        </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-white border border-gray-300 hover:border-gray-400 focus-within:border-black rounded-md overflow-hidden transition-colors">
                        <Input
                          ...
                          className="w-full border-0 text-black focus:ring-0 focus:ring-offset-0"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Button
                          variant="outline"
                          onClick={handleNow}
                          className="text-xs border-gray-300 text-black hover:bg-gray-100 transition-colors"
                        >
                          Now
                        </Button>
                        <Button
